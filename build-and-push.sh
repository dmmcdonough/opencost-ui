...
REPO="${OPENCOST_REPO:-${REGISTRY}/sandbox-dhwjqy/opencost}"
TAG="${OPENCOST_TAG:-$(git rev-parse --short HEAD)}"
IMAGE="${REPO}/opencost:${TAG}"
...
echo "==> Building opencost image: ${IMAGE}"
nerdctl build \
